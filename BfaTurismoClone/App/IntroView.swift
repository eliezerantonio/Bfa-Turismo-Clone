...
struct Home: View {
    ...
    @State var intros: [Intro] = [
        Intro(title: "Stay Relaxed", subTitle: "Take Deep Breaths", description: "Staying calm at work can help you build relationships with your coworkers and think logically.", img: "intro1", color: Color("CustomTealColor")),

        Intro(title: "Stay Creative", subTitle: "Keep Ideas Fresh", description: "Creativity comes slowly; it's a process and you have to nurture it. Creativity needs to be nurtured.", img: "intro2", color: Color("CustomDarkGrayColor")),

        Intro(title: "Stay Organized", subTitle: "Create Task List", description: "Half the battle of being a professional artist is simply staying organized.", img: "intro3", color: Color(Color.teal)),
    ]
